...
import com.malky.collegealert.presentation.composables.NavigationCard
            ...
            DeviceConfiguration.DESKTOP -> {
                Row(
                    ...
                    Column(
                        modifier = Modifier
                            .widthIn(max = 128.dp)
                            .fillMaxHeight(if (deviceConfiguration == DeviceConfiguration.MOBILE_LANDSCAPE) 1f else 0.7f)
                            .padding(8.dp),
