package com.malky.uninotify.presentation.theme

import androidx.compose.ui.graphics.Color

val Primary = Color(0xFF1E88E5)  //Primary
val PrimaryForeground = Color(0xFFFFFFFF) //OnPrimary

val Secondary = Color(0xFFFB8C00) //Secondary
